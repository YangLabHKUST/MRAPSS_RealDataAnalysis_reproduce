run_IVW_func <- function(dat, Threshold, exposure="Trait 1", outcome="Trait 2"){
  res = NULL
  for(Thresh in Threshold){
    ...
    #Raps
    res.IVW <- try(TwoSampleMR::mr_ivw_fe(dat$b.exp[indx], dat$b.out[indx],
